# My Webpack SPA Learning Project

This project was created as a hands-on way to learn and understand the fundamentals of building Single-Page Applications (SPAs) using Webpack. It explores concepts like module bundling, asset management, and basic SPA routing.

## What I Learned

Through this project, I experimented with:

* **Webpack Configuration:** Setting up a `webpack.config.js` file to bundle JavaScript modules, handle CSS, and manage assets.
...
* Exploring different Webpack optimizations for production builds.
* Implementing unit and integration tests.

This project was a fun and educational journey into the world of Webpack and SPAs!
